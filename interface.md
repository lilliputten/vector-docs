> $Id: interface.md 10528 2018-08-10 11:23:09Z miheev $
...
Для создания групп с выводом параметров или организации форм воода данных
используются блоки `ValueCell`, группирующиеся в `ValuesGroup`.
...
Аналогично `actions__item`, список типов используемых ячеек может расширяться (как минимум, необходимо будет добавить селекторы). См.:

- `WEB_TINTS/source/blocks/interface/ValueCell/_type/ValueCell_type_*.*`,
- `WEB_TINTS/source/blocks/interface/ValueCell/_xType/ValueCell_xType_*.*`.
